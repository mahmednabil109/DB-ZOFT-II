...
- [X] adding the validation to the index.
...
- [X] finish the Unit test of the dbApp as a whole.
...
- [X] test correctness of the `AND` `OR` `XOR` operators with actual queries.
    - test and with and without index. 
- [X] test correctness of the result of empty, single , multiple and range queries with help of python script.
- [X] test correctness and the consistancy of the queries after and before deleting related and non-related rows.
